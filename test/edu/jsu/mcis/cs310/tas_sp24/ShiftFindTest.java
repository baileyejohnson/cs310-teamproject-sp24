...
public class ShiftFindTest {
    ...
    public void testFindShiftByID2() {
        ...
        Shift s2 = shiftDAO.find(3);
        Shift s3 = shiftDAO.find(4);

        /* Compare to Expected Values */
        
        assertEquals("Shift 2: 12:00 - 20:30 (510 minutes); Lunch: 16:30 - 17:00 (30 minutes)", s1.toString());
        assertEquals("Shift 1 Early Lunch: 07:00 - 15:30 (510 minutes); Lunch: 11:30 - 12:00 (30 minutes)", s2.toString());
        assertEquals("Shift 3: 22:30 - 07:00 (510 minutes); Lunch: 02:30 - 03:00 (30 minutes)", s3.toString());
    ...
    public void testFindShiftByBadge2() {
        ...
        Badge b1 = badgeDAO.find("860CBBEE");
        Badge b2 = badgeDAO.find("398B1563");
        Badge b3 = badgeDAO.find("95497F63");
    ...
    public void testFindShiftByBadge3() {
        ...
        Badge b1 = badgeDAO.find("76118CDC");
        Badge b2 = badgeDAO.find("76118CDC");
        Badge b3 = badgeDAO.find("76118CDC");
