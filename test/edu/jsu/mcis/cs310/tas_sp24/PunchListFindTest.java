...
public class PunchListFindTest {
    ...
    public void testFindPunchList4() {
        ...
        LocalDate ts = LocalDate.of(2018, Month.AUGUST, 20);
        ...
        /* Add Punches */
        p2.add(punchDAO.find(1903));
        p2.add(punchDAO.find(1983));
    ...
    public void testFindPunchList5() {
        ...
        LocalDate ts = LocalDate.of(2018, Month.SEPTEMBER, 8);

        Badge b = badgeDAO.find("B5A117E9");
        ...
        /* Add Punches */
        p2.add(punchDAO.find(3780));
        p2.add(punchDAO.find(3842));
